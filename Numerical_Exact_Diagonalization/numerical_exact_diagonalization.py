...
def hamiltonian_heisenberg(state, num_sites, num_spin_states, bond_info):
    ...
    for bond in bond_info:
        final_state += heisenberg_kinetic(bond, state)
...
def generate_hamil_matrix_heisenberg(num_sites, num_particles_spin_sep, bond_info, all_possible_states):

    all_possible_states_hashed = list(map(hash, all_possible_states))

    hamiltonian_filled = lambda state: hamiltonian_heisenberg(state, num_sites, len(num_particles_spin_sep), bond_info)
...
def solve_energies(num_sites, num_particles_spin_sep, bond_info):
    ...
    hamil_matrix = generate_hamil_matrix_heisenberg(num_sites, num_particles_spin_sep, bond_info, all_possible_states)
